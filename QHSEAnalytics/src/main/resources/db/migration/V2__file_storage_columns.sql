-- ============================================================
-- QHSE Analytics — V2 : Indexes de performance
-- CONCURRENTLY retiré : incompatible avec les transactions Flyway.
...
-- Import intermédiaire : purge quotidienne par date
