...
/**
 * Valide les fichiers Excel uploadés :
 * — limite de taille
 * — vérification de la signature magique (magic bytes) réelle, pas juste l'extension
 * — liste blanche des MIME types déclarés
 */
@Component
public class ExcelFileValidator {
    ...
    // XLS  = CFBF : signature D0 CF 11 E0
    ...
    private static final Set<String> ALLOWED_MIME_TYPES = Set.of(
            ...
            "application/octet-stream" // certains navigateurs envoient ce type générique
    );
    ...
    public void validate(MultipartFile file) {
        ...
        // 3. MIME type déclaré par le navigateur (première ligne de défense)
        ...
        // 4. Vérification de la signature magique (anti-upload de fichiers déguisés)
